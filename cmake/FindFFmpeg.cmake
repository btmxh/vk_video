...
macro(find_component _component _pkgconfig _library _header)
    ...
    set(${_component}_LIBRARY_DIRS
        ${PC_${_component}_LIBRARY_DIRS}
        CACHE STRING
        "The ${_component} library dirs."
    )
    set(${_component}_LIBRARIES
        ${PC_${_component}_LIBRARIES}
        CACHE STRING
        "The ${_component} libraries."
    )
...
if(NOT FFMPEG_LIBRARIES)
    ...
    foreach(_component ${FFmpeg_FIND_COMPONENTS})
        if(${_component}_FOUND)
            message(
                STATUS
                "Libs: ${${_component}_LIBRARIES} | ${PC_${_component}_LIBRARIES}"
            )
            ...
            if(NOT TARGET FFmpeg::${_lowerComponent})
                ...
                set_target_properties(
                    FFmpeg::${_lowerComponent}
                    PROPERTIES
                        INTERFACE_COMPILE_OPTIONS "${${_component}_DEFINITIONS}"
                        INTERFACE_INCLUDE_DIRECTORIES
                            ${${_component}_INCLUDE_DIRS}
                        INTERFACE_LINK_LIBRARIES
                            "${${_component}_LIBRARY} ${${_component}_LIBRARIES} ${PC_${_component}_LIBRARIES}"
                        INTERFACE_LINK_DIRECTORIES
                            "${PC_${_component}_LIBDIR} ${PC_${_component}_LIBRARY_DIRS} ${PC_FFMPEG_LIBRARY_DIRS}"
